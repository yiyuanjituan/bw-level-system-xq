  ...
  <div class="mb-[10px]">
    <div class="domain-box" ref="saveImageRef">
      <div class="title-box">
        ...
        <span class="copy-action capture-ignore" @click="copyFun(`官方邮箱: ${app.appInfo.email}`)">
      ...
      <div class="link-box">
        <div class="link-item">
          <span class="label">官方邮箱</span>
          <span class="text">{{ app.appInfo.email }}</span>
          <span class="link-icon capture-ignore" @click="copyFun(app.appInfo.email)">
