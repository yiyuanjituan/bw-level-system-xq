...
async function copyMemberId(userIdx: number) {
  try {
    await toClipboard(String(userIdx));
            ...
            <span class="col">
              <div class="account-col flex items-center">
                ...
                <span class="member">
                  ...
                  <button class="copy" type="button" aria-label="复制会员ID" @click="copyMemberId(member.userIdx)">
